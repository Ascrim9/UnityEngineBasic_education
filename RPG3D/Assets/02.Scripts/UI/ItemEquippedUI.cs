...
namespace RPG.UI
{
    public class ItemsEquippedUI : UIMonoBehaviour
    {
        ...
        protected override void Awake()
        {
            ...
            _presenter = new();
            for (var i = 0; i < _presenter.itemsEquippedSource.itemsEquippedSlotDatum.Count; i++)
            {
            ...
            _presenter = new();
            foreach (var VARIABLE in _presenter.itemsEquippedSource.itemsEquippedSlotDatum)
            {
            }
